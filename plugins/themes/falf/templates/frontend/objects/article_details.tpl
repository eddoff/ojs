{**
 * copied from: templates/frontend/objects/article_details.tpl
 *
		...
		<div class="main_entry">
			...
			function openTabs(evt, tabName) {
			    ...
			    for (i = 0; i < tablinks.length; i++) {
			        tablinks[i].className = tablinks[i].className.replace(" tabs_button_high", "");
			    }
			    document.getElementById(tabName).style.display = "block";
			    evt.currentTarget.className += " tabs_button_high";
			    }
			{/literal}
			</script>
			 {*   document.getElementById("defaultOpen").click();			 *}
			<div id="tabs_tabbar">
			  <button class="tabs_button tabs_button_high tablinks" id="defaultOpen" onclick="openTabs(event, 'tabs_abstract')">Abstract</button>
			  <button class="tabs_button tablinks" onclick="openTabs(event, 'tabs_references')">References</button>
			  <button class="tabs_button tablinks" onclick="openTabs(event, 'tabs_cited-by-crossref')">Cited in Crossref</button>
			  <!-- <button class="tabs_button tablinks" onclick="openTabs(event, 'tabs_citationsGS')" -->
			  <button class="tabs_button tablinks" onclick="openTabs(event, 'tabs_citationsGS') ; window.open('{$doiUrl|replace:'https://doi':'http://scholar.google.com/scholar?q=link:dx.doi'}', '_blank')">Google Scholar</button>
			</div>
<br />
			{* Abstract *}
			{if $article->getLocalizedAbstract()}
				<div id="tabs_abstract" class="item abstract tabs">
			...
			{if $parsedCitations->getCount() || $article->getCitations()}
				<div id="tabs_references" class="item references tabs" style="display:none">
					<h3 class="label">
			...
			{/if}
			{* Citations *}
				<div id="tabs_cited-by-crossref" class="item cited-by-crossref tabs" style="display:none">
					<h3>This article has been cited by:</h3>
					<div id="cited-by-list"> </div>
				</div>
				<div id="tabs_citationsGS" class="item citationsGS tabs" style="display:none">
					<h3>Citations from Google Scholar is <a href="{$doiUrl|replace:'https://doi':'http://scholar.google.com/scholar?q=link:dx.doi'}" target="_blank" >opened in new tab</a> </h3>
				</div>

  <!-- http://scholar.google.com/scholar?q=link: -->
